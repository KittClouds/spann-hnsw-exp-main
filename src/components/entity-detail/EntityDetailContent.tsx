    ...
    <div className={`flex flex-col h-full ${className}`}>
      ...
      <div className="border-b border-border p-4">
        <div className="flex items-center justify-between">
          <span className="font-semibold truncate">{entity.label}</span>
      ...
      <div className="flex-1 overflow-hidden">
        <Tabs defaultValue="attributes" className="w-full h-full">
          ...
          <TabsContent value="attributes" className="h-[calc(100%-60px)] m-4">
          ...
          <TabsContent value="relationships" className="h-[calc(100%-60px)] m-4">
            <ScrollArea className="h-full pr-4">
          ...
          <TabsContent value="references" className="h-[calc(100%-60px)] m-4">
            <ScrollArea className="h-full pr-4">
              {references.length > 0 ? (
          ...
          <TabsContent value="co-occurrences" className="h-[calc(100%-60px)] m-4">
            <ScrollArea className="h-full pr-4">
              <div className="space-y-2">
          ...
          <TabsContent value="global-relationships" className="h-[calc(100%-60px)] m-4">
            <ScrollArea className="h-full pr-4">
              <div className="space-y-2">
                <div className="flex items-center gap-2 mb-4">
