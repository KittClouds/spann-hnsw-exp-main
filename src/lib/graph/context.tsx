...
interface GraphContextType {
  ...
  exportElement: (elementId: string) => any | undefined;
  importElement: (elementJson: any) => void;
...
/**
 * Service instance for the whole application
 * Using a single instance ensures consistency across the app
 */
  ...
  const value: GraphContextType = {
    ...
    addNote: (note) => {
      ...
      const node = graphService.addNote({
        ...
        ...note
      }, note.parentId || undefined, clusterId);
